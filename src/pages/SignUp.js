...
function SignUp() {
    ...
    async function uploadImage(){
        ...
        data.append('upload_preset','hl4twdxh');
        try{
            setUploadingImg(true);
            let res = await fetch('https://api.cloudinary.com/v1_1/das9oh9bs/image/upload',{
                method:'post',
                body:data
            })
    ...
    <Row>
        <Col md={7} className="d-flex align-items-center justify-content-center flex-direction-column">
            ...
            <Form.Group className="mb-3" controlId="formBasicName">
                    ...
                    <Form.Control type="text" placeholder="Enter Your User Name" onChange={(e)=>setName(e.target.value)} value={name}/>
                </Form.Group>
